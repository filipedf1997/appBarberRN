...
export default CustomTabBar = ({ state, navigation }) => {
  ...
  return(
    <TabArea>
      ...
      <TabItemCenter onPress={() => goTo('Appointments')} style={{ backgroundColor: state.index === 2 ? '#FFF' : '#d0f2f7' }}>
      ...
      <TabItem onPress={() => goTo('Profile')}>
        { user.avatar != '' ? 
          <AvatarIcon source={{uri: user.avatar}} style={{ opacity: state.index === 4 ? 1 : 0.8 }} /> :
